...
After [setting up Dreamlab on your server](#), navigate to `game-client.example.com/?gameId=u_your_user/your-game-id&server=ws://mp.example.com` and the client will automatically request a new lobby be started and connect to it.
