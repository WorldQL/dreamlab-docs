...
<img src={require("../../static/img/image-1.png").default} alt="Roots screenshot" width="250" />
...
Every root (`world`, `local`, `server`, `prefabs`) exposes a **proxy** called `_.` that lets you grab children by name
with dot-syntax.

| What you type                    | What it returns                   |
| -------------------------------- | --------------------------------- |
| `game.prefabs._.Player`          | The _Player_ entity prefab        |
| `game.prefabs._.Player._.Health` | Child entity named _Health_       |
| `game.world._.Enemy42`           | Runtime instance called _Enemy42_ |
