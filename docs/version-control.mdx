...
Dreamlab includes integrated, Git-style version control. Use it to track file changes, review diffs and history, and
manage branches — all within the editor.
...
> **Important:** Deployments read from the **remote main branch**. Committing is local; **your deployed game will not
> update until you Push**.
